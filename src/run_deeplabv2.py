...
def generate_model_masks(model):
    ...
    for plant in data.plants:
        ...
        utils.write_image(mask, plant.deeplabv2_mask_path)
        ...
        plant_data['deeplabv2_flower_area'] = model_flower_area
...
if __name__ == '__main__':
    ...
    state_dict = torch.load(config.DEEPLABV2_PATH, map_location=lambda storage, loc: storage)
